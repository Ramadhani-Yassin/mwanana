...
export function WhyChooseUs() {
  return (
    <section className="mw-section mw-section--paper" id="about">
      <div className="mw-container">
        <div className="mw-why">
          <div className="mw-why__visual" data-animate>
            <div className="mw-why__frame">
              <Image
          ...
          <div className="mw-why__copy">
            <header data-animate>
              <p className="mw-eyebrow">Why choose us</p>
            ...
            <ul className="mw-why__list">
              {points.map((p) => (
                <li key={p.title} className="mw-why__item" data-animate>
                  <div className="mw-why__icon">{p.icon}</div>
                  <div>
                    <h3>{p.title}</h3>
                    <p>{p.description}</p>
                  </div>
