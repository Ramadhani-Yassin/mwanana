...
export function Services() {
  return (
    <section className="nc-section" id="services">
      <div className="nc-container">
        <header className="nc-section__head" data-animate>
          <p className="nc-eyebrow">What we do</p>
          <h2>Our Services</h2>
          <p>
        ...
        <div className="nc-services-grid">
          {services.map((s) => (
            <article key={s.title} className="nc-card" data-animate>
              <div className="nc-card__icon">{s.icon}</div>
              <h3>{s.title}</h3>
              <p>{s.description}</p>
              <a className="nc-link" href="#contact">
