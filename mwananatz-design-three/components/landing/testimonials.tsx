...
export function Testimonials() {
  return (
    <section className="nc-section" id="magazine">
      <div className="nc-container">
        <header className="nc-section__head" data-animate>
          <p className="nc-eyebrow">Voices</p>
          <h2>What our partners say</h2>
          <p>Results, relationships, and the long view — in their words.</p>
        </header>
        <div className="nc-quote-grid">
          {items.map((t) => (
            <blockquote key={t.name} className="nc-quote" data-animate>
              <p>{t.quote}</p>
              <footer>
